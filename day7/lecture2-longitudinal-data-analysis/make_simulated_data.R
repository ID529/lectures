...
write.csv(df, here(analysis_dir, "example_dataset_1.csv"), row.names=F)

# cleanup environment, delete everything except for df that this script created
rm(list = c(
  'cohort_1_2005', 'cohort_2_2005', 'cohort_3_2005', 'cohort_4_2005',
  'cohort_1_2010', 'cohort_2_2010', 'cohort_3_2010', 'cohort_4_2010',
  'cohort_1_2015', 'cohort_2_2015', 'cohort_3_2015', 'cohort_4_2015',
  'cohort_1_2020', 'cohort_2_2020', 'cohort_3_2020', 'cohort_4_2020',
  'cohorts', 'N', 'n_cohorts', 'years', 'keep_roughly_steady', 'roughly_decline',
  'roughly_increase'
))
