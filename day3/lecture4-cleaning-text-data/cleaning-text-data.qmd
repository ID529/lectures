...
-   **We have now learned a bit about `dplyr` and how it can be used to:**
...
-   **However, we have not discussed methods for handling and manipulating text data**
    -   Text manipulation is an important component of the data cleaning process
    -   Text strings introduce many challenges in the data cleaning process:
...
- [We must process and clean text strings before data analysis can occur]{.blue-bold}
...
![](images/cheatsheet-stringr-regex-overview-1.png){.absolute height="80%" left="0%" bottom="8%"}
...
![](images/gif-absorbing-knowledge.gif){.absolute height="70%" top="10%" left="7%"}
...
-   Base R and `stringr` offer a range of functions for working with text and implementing regex
