...
data %>% 
  ...
  select(id, height, height_in, weight, weight_lbs) 
```
::: 
...
-   `.data` = a data frame 
-   `.groups` = Name value pairs of the summary function(s) to apply
...
-   Select sequences columns of interest
    ...
    -   This is a regular expressions pattern (more to come soon)
